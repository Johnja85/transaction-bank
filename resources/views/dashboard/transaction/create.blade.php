    ...
    <div class="py-12">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg space-y-6">
            <form action="{{ route('transaction.store') }}" method="POST">
                ...
                <div>
                    ...
                    <select name="account" id="account">
                        ...
                        @foreach ( $accounts as $account )
                            <option value="{{ $account->idaccount }}" >{{ $account->idaccount }} {{$account->description }}</option>
                        @endforeach 
                    </select>
                ...
                <div>
                    <label for="">Destionation Account</label>
                ...
                <div>
                    <input class="form-group hidden" type="text" name="type" value='own'>
                </div>
